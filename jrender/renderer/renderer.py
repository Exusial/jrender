...
class Renderer(nn.Module):
    ...
    def execute(self, vertices, faces, textures=None,mode='rgb', texture_type='surface', metallic_textures=None, roughness_textures=None, vertex_colors=None):
        mesh = Mesh(vertices, faces, textures=textures, texture_type=texture_type, metallic_textures=metallic_textures, roughness_textures=roughness_textures, vertex_colors=vertex_colors)
